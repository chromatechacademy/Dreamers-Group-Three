Feature: MOBILE - Mobile responsiveness
    ...
    Scenario: As a Chroma Tech faculty member or any user who can access the Chroma Tech School Management System, I want to be able to have a pleasant user experience without any issues.
        ...
        Then Start to type your Then step here the teacher should see the modules described in Description "Class Timetable", "Teachers Timetable", "Assign Class Teacher", "Promote Students", "Subject Group", "Subjects", "Class", "Sections", and also perform some manual testing operations on the device
