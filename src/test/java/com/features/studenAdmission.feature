Feature: Student Admmission Number
    ...
    Scenario: Student Admission Unique admission number
        ...
        And enters "5568" for Admission No 
        ...
        And enters "5568" for admission number
        ...
        And user checks the box with admission number "5568"
        And user clicks on Delete button 
        Then the student with unique number "5568" is not displayed
